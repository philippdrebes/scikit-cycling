...
# machinery.
builtins.__SKCYCLING_SETUP__ = True

with open('skcycling/__init__.py') as fid:
    for line in fid:
...
def configuration(parent_package='', top_path=None):
    ...
    config.add_subpackage('skcycling')
...
if __name__ == "__main__":
    try:
        ...
        if len(sys.argv) >= 2 and ('--help' in sys.argv[1:] or
            ...
            print('To install scikit-cycling from source, you need numpy.' +
